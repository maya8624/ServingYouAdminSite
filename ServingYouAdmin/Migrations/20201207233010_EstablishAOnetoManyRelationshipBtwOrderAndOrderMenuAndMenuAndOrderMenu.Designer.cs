...
namespace ServingYouAdmin.Migrations
{
    ...
    [Migration("20201207233010_EstablishAOnetoManyRelationshipBtwOrderAndOrderMenuAndMenuAndOrderMenu")]
    partial class EstablishAOnetoManyRelationshipBtwOrderAndOrderMenuAndMenuAndOrderMenu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServingYouAdmin.Models.OrderMenu", b =>
                {
                    b.HasOne("ServingYouAdmin.Models.Menu", null)
                        .WithMany("OrderMenu")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServingYouAdmin.Models.Order", null)
                        .WithMany("OrderMenu")
